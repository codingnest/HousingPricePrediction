...
class FeaturePreparer:
    ...
    def separate_variable_types(self) -> None:
        ...
        self.numerical = [var for var in self.raw_data.columns
                     if self.raw_data[var].dtype != 'O']
        print('There are {} numerical variables'.format(len(self.numerical)))
        ...
        self.continuous = [
            var for var in self.numerical if
    ...
    def split_data(self, *, training: bool = False) -> None:
        ...
        if training:
            return self.X_train, self.X_test, self.y_train, self.y_test = train_test_split(
                                                                                        self.prepared_data,
