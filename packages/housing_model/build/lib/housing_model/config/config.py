...
PACKAGE_ROOT = pathlib.Path(housing_model.__file__).resolve().parent
#E:\Coding Nest\DataScience_Nov2019\CourseMaterials\HousePricePrediction\packages\housing_model\housing_model
#print(PACKAGE_ROOT)
